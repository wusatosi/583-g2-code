...
python optimize.py --iterations=30 --num_components_min=1 --num_components_max=20 --range_low=0.666666 --range_high=1.500000 --prob_jump=0.5 --no_jump_threshold=1.0 --seed=1